...
public class LoginActivity extends ActionBarActivity {
                ...
                parseUserQuery.findInBackground(new FindCallback<ParseObject>() {
                    ...
                    public void done(List <ParseObject> arg0, ParseException arg1) {
                        ...
                        if (arg1 == null) {
                            ...
                            if (arg0 != null && arg0.size() > 0) {
                                ...
                                if (username != null) {
                                    ...
                                    if (!username.equals(existingUsername)) {
                                        ...
                                        showToast("Username is already in use. Please try again");
                                        return;
                                    }
                                }
                                if (email != null) {
                                    ...
                                    if (!email.equals(existingEmail)) {
                                        ...
                                        showToast("Email is already in use. Please try again");
                                        return;
                                    }
                                }
                            ...
                            showToast("Error sign up, please try again" + " "+ "Error login please try again.");
                    }
    ...
    private void doSignUp() {
        ...
        progressDialog = ProgressDialog.show(LoginActivity.this,"Sign up in proccess","please wait");
    ...
    private void doLogin() {
        ...
        // app id)
        progressDialog = ProgressDialog.show(LoginActivity.this,
                "Please wait...","Login in progress..." + " '" + username+ "'");
